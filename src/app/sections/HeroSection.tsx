	...
	return (
		<section className='pt-12 pb-20 px-6 min-h-[calc(100vh-120px)] md:min-h-screen flex items-center bg-gray-50'>
			...
			<div className='text-left'>
				...
				<div className='flex flex-col sm:flex-row gap-6 md:ml-[4px]'>
						<a
							href='#contact'
							className='bg-blue-600 text-white px-6 py-3 sm:px-8 sm:py-4 rounded-lg hover:bg-blue-700 transition-colors font-medium text-base sm:text-lg md:text-xl w-fit'
						>
							Get in touch
						</a>
					</div>
