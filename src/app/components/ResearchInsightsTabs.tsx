...
const tabs = [
	...
	},
	{
		...
		description: 'Conducted interviews with sellers, sales teams, and CRM stakeholders to understand user needs and business requirements.',
		type: 'image' as const,
	...
	return (
		<section className='pt-0 pb-8 sm:pb-12 lg:pb-16 px-4 sm:px-6 lg:px-8'>
			<div className='max-w-6xl mx-auto'>
				<div className='sm:bg-gray-50 sm:p-8 sm:rounded-[20px] w-screen sm:w-full mb-16 -mx-4 sm:mx-auto min-h-[800px]'>
					<div className='flex flex-col lg:flex-row gap-6 lg:gap-8'>
						{/* Accordion on the left */}
						<div className='flex-shrink-0 lg:w-96 px-4 sm:px-0'>
						...
						<div className='flex-1 overflow-x-auto overflow-y-hidden scrollbar-thin scrollbar-thumb-gray-400/50 scrollbar-track-transparent hover:scrollbar-thumb-gray-400/70 scrollbar-thumb-rounded-full'>
							{activeTabData.type === 'radar' ? (
								...
								<div className={activeTab === 'stakeholder' ? 'overflow-hidden rounded-lg' : ''}>
									<Image
										src={activeTabData.image || ''}
										alt={`${activeTabData.label} - Customer journey map showing user flows and pain points`}
										width={1400}
										height={800}
										className={activeTab === 'stakeholder' 
											? 'w-full h-auto min-w-[800px] sm:min-w-0 scale-[1.3] origin-top-left' 
											: 'w-full h-auto rounded-lg min-w-[800px] sm:min-w-0'}
										quality={90}
									/>
								</div>
							)}
